...
scotchApp.controller('deliveryChallanController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.toggleModal = function () {
        if (this.CustomerName == null || this.CustomerName == "") {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_Item_for_delivery_Challan/' + getitem_id)
           .success(function (res) {
               // console.log(res);
               ...
               $scope.additeminlist = function () {
                   ...
                   if (qty == null || qty == "") {
                       ...
                       var request = $http({
                           ...
                           method: "post",
                           url: "http://minvent.azurewebsites.net/api/Customer_Item_Invoice",
                           crossDomain: true,
                           data: {
                           ...
                           $http.get('http://minvent.azurewebsites.net/api/View_Customer_Item_Invoice?customer_Id=' + customer_id + '&insertedDate=' + insertedDate)
                              .success(function (res) {
                                  $scope.additem = res;
                              })
                       });
               ...
               $scope.deleteitemfrmlist = function (index, aitem) {
                  ...
                  .success(function (res) {
                      ...
                      var request = $http({
                          ...
                          method: "delete",
                          url: "http://minvent.azurewebsites.net/api/Customer_Item_Invoice/" + itemid,
                          crossDomain: true,
                          data: {
    ...
    $scope.custid = function (CustomerName) {
        ...
        $http.get('http://minvent.azurewebsites.net/api/customer_view/' + cust_id)
       .success(function (res) {
           console.log(res);
    ...
    $scope.saveChallan = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/customer_view/' + customer_Id)
       .success(function (res) {
           console.log(res);
           $scope.getCustomerscitycno = res;
           var cust = $scope.getCustomerscitycno;
           ...
           var request = $http({
               method: "post",
               url: "http://minvent.azurewebsites.net/api/DeliveryChallans",
               crossDomain: true,
               data: {
                   // DataFiledName:VariableName
    ...
    $scope.removeItemFromItemList = function (id, quantity, itemId) {
       ...
       .success(function (res) {
           ...
           var request = $http({
               ...
               method: "delete",
               url: "http://minvent.azurewebsites.net/api/Customer_Item_Invoice/" + id,
               crossDomain: true,
               data: {
