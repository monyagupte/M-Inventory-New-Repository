...
scotchApp.controller('reportDetailsController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //    $http.get('http://minvent.azurewebsites.net/api/SP_SelectDateWiseData?' + "startDate=" + startdate + "&endDate=" + enddate)
    ...
    //        //$http.get('http://minvent.azurewebsites.net/api/Sp_Daily_Sales_Register?' + "Duration=" + duration)
    //        //  .success(function (res) {
    ...
    //    $http.get('http://minvent.azurewebsites.net/api/SP_CustomerItemWiseDates?startdate=' + startdate + '&enddate=' + enddate + '&cust_id=' + cust_Id + '&item_id=' + item_Id)
    //   .success(function (res) {
