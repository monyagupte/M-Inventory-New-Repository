...
scotchApp.controller('dailyProfitAndLossController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.ShowRecords = function () {
       ...
       // alert(startDate);
       // alert(endDate);
        //http://minvent.azurewebsites.net/api/Sp_Daily_Profit_And_Loss?startdate=2015-12-12&enddate=2016-1-31
        $http.get('http://minvent.azurewebsites.net/api/Sp_Daily_Profit_And_Loss?startdate=' + startDate + '&enddate=' + endDate)
