var scotchApp = angular.module('scotchApp.expenseReport', ['ngRoute']);
scotchApp.controller('expenseReportController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.ShowRecords = function () {
        ...
        // alert(startDate);
        // alert(endDate);
        //http://minvent.azurewebsites.net/api/SP_ExpensesReport?startdate=2015-12-01&enddate=2016-1-31
        $http.get('http://minvent.azurewebsites.net/api/SP_ExpensesReport?startdate=' + startDate + '&enddate=' + endDate)
