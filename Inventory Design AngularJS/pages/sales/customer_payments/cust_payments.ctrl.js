...
scotchApp.controller('custPaymentController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/View_Customer_Payment_SalesInvoice')
       ...
       $scope.getCustPayment = res;
        ...
        else if (Duration == last15days)
        {
            ...
            for (var i = $scope.day; i <= 15; i--) {
                ...
                alert(finalDate);
                $http.get('http://minvent.azurewebsites.net/api/View_Customer_Payment_SalesInvoice/' + finalDate)
               .success(function (res) {
