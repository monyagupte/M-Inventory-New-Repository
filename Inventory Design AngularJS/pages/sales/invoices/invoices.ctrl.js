...
scotchApp.controller('invoicesController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
               ...
               $scope.additeminlist = function () {
                   ...
                   if (qty == null || qty == "") {
                       ...
                       var request = $http({
                           ...
                           $http.get('http://minvent.azurewebsites.net/api/View_Customer_Item_Invoice?cust_id=' + customer_id + '&insertedDate=' + dateInserted)
                              .success(function (res) {
                                  $scope.additem = res;
                   ...
                   $scope.deleteitemfrmlist = function (index, aitem) {
                       ...
                       $http.get('http://minvent.azurewebsites.net/api/View_Item/' + aId)
                         .success(function (res) {
                             console.log(res);
                             $scope.getItemstocks = res;
                             var itemstock = $scope.getItemstocks;
                             ...
                             var request = $http({
                                 ...
                                 method: "put",
                                 url: "http://minvent.azurewebsites.net/api/Items/" + aId,
                                 crossDomain: true,
                                 data: {
                                     //DataFiledName:VariableName
                                     Id: aId,
                       ...
                       var request = $http({
                           ...
                           method: "delete",
                           url: "http://minvent.azurewebsites.net/api/Customer_Item_Invoice/" + invoiceId,
                           crossDomain: true,
                           data: {
    ...
    $scope.custid = function (CustomerName) {
       ...
       .success(function (res) {
           ...
           $scope.payment = function (netamount) {
               ...
               var request = $http({
                   method: "post",
                   url: "http://minvent.azurewebsites.net/api/SalesInvoices",
                   crossDomain: true,
                   data: {
                       // DataFiledName:VariableName
           ...
           $scope.savePayment = function () {
               ...
               if (paymenttype == 'Cheque') {
                   ...
                   var request = $http({
                       method: "post",
                       url: "http://minvent.azurewebsites.net/api/CustomerPayments",
                       crossDomain: true,
                       data: {
                           Customer_ID: Customer_Id,
    ...
    $http.get('http://minvent.azurewebsites.net/api/units')
       .success(function (res) {
           //  console.log(res);
           $scope.getUnits = res;
 ...
 .success(function (res) {
    ...
    //code for GET CITY
    $http.get('http://minvent.azurewebsites.net/api/County_State_City_View')
       .success(function (res) {
           console.log(res);
           $scope.getCity = res;
