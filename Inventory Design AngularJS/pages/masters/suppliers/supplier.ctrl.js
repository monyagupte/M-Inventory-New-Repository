...
scotchApp.controller('suppliersController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.save = function () {
        ...
        if (Name == null || City_Id == null || City_Id == "" ) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/suppliers",
                crossDomain: true,
                data: {
    ...
    $scope.editSupplier = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/Supplier_view/' + Supplier_Id)
     .success(function (res) {
         console.log(res);
    ...
    $scope.update = function () {
        ...
        if (Name == null || City_Id == null || City_Id == "" || ContactNo == null || ContactNo2 == null || EmailId == null || EmailId2 == null || VatNo == null || TinNo == null || Street == null || Area == null || Pincode == null || Note == null) {
            ...
            var request = $http({
                method: "put",
                url: "http://minvent.azurewebsites.net/api/suppliers/" + supplier_Id,
                crossDomain: true,
                data: {
                    ID: supplier_Id,
