...
//condition will check if user has left any field vacant
        if (Name == null || Description == null) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/units",
                crossDomain: true,
                data: {
    ...
    $scope.editUnits = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_Unit/' + unit_Id)
     .success(function (res) {
         console.log(res);
    ...
    $scope.update = function () {
        ...
        var request = $http({
            method: "put",
            url: "http://minvent.azurewebsites.net/api/units/" + unit_Id,
            crossDomain: true,
            data: {
                ID: unit_Id,
