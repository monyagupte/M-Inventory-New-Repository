...
scotchApp.controller('categoriesController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
          ...
          var Descriptions = $scope.description;
              ...
              if (parent == 0) {
                  ...
                  if (CategoryNames == null || Descriptions == null) {
                      ...
                      var request = $http({
                          method: "post",
                          url: "http://minvent.azurewebsites.net/api/categories",
                          crossDomain: true,
                          data: {
                              Name: CategoryNames,
    ...
    $scope.editCategories = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_Categories/' + categories_Id)
    .success(function (res) {
        ///console.log(res);
    ...
    $scope.updateCategories = function () {
        ...
        if (name == null || description == null || parentCategory == null || parentCategory == "") {
            ...
            var request = $http({
                method: "put",
                url: "http://minvent.azurewebsites.net/api/Categories/" + ID,
                crossdomain: true,
                data: {
