...
scotchApp.controller('countryStateCitysController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //Get Country
    $http.get('http://minvent.azurewebsites.net/api/View_country')
         .success(function (res) {
    ...
    //Get States
    $http.get('http://minvent.azurewebsites.net/api/View_State')
         .success(function (res) {
    ...
    //Get City
    //$http.get('http://minvent.azurewebsites.net/api/View_City')
    //     .success(function (res) {
    ...
    $scope.BlankFields = function () {
       ...
       // var state = $scope.state;
        if (country == "" || country == null) {
            ...
            $scope.stateNameDiv = false;
            // alert('state');
            $http.get('http://minvent.azurewebsites.net/api/View_state?country_Id=' + country)
            //$http.get('http://minvent.azurewebsites.net/api/View_State/' + country)
             .success(function (res) {
                 $scope.getState = res;
             })
    ...
    $scope.checkOtherState = function () {
        ...
        ////  alert(country);
        //$http.get('http://minvent.azurewebsites.net/api/View_State/' + country_ID)
        // .success(function (res) {
        //     $scope.getState = res;
        // })
    ...
    $scope.saveCountry = function () {
        ...
        if (country == "other") {
            ...
            if ($scope.countryName == null || $scope.countryName == "") {
                ...
                var request = $http({
                    method: "post",
                    url: "http://minvent.azurewebsites.net/api/countries",
                    crossDomain: true,
                    data: {
    ...
    $scope.getcountryStateCity = res;
        ...
        $scope.saveState = function () {
            ...
            if (country == "" || country == null) {
                ...
                var request = $http({
                    method: "post",
                    url: "http://minvent.azurewebsites.net/api/states",
                    crossDomain: true,
                    data: {
                        StateName: stateName,
                        Country_ID:country,
...
//    }
        ...
        $scope.saveCity = function () {
            ...
            if (cityName == null || cityName == "") {
                ...
                var request = $http({
                    method: "post",
                    url: "http://minvent.azurewebsites.net/api/cities",
                    crossDomain: true,
                    data: {
                        City1: cityName,
                        State_ID: state,
...
//    }
    ...
    $scope.save = function () {
        ...
        if (Uname == null || Fname == null || Lname == null || Role == null || Role == "" || Company_ID == null || Company_ID == "" || Contact == null || Email == null || Birth == null) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/Users",
                crossDomain: true,
                data: {
             ...
             .success(function (responce) {
                 ...
                 //further code will refresh the current database data on page
                 $http.get('http://minvent.azurewebsites.net/api/View_Users')
     .success(function (res) {
         var x = res.length;
         $scope.x = x;
         // console.log(res);
    ...
    $scope.deleteuser = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_Users/' + user_Id)
    .success(function (res) {
        // console.log(res);
        ...
        var request = $http({
            method: "put",
            url: "http://minvent.azurewebsites.net/api/Users/" + ID,
            crossdomain: true,
            data: {
