...
scotchApp.controller('UconController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/View_New_Units')
       .success(function (res) {
           $scope.upbtn = false;
           $scope.savebtn = true;
           console.log(res);
    ...
    $scope.save = function () {
        ...
        if (Fquant == null || Funit == null || Funit == "" || Tquant == null || Tunit == null || Tunit == "") {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/NewUnits",
                crossDomain: true,
                data: {
                    FromQuantity: Fquant,
                    FromUnit: Funit,
    ...
    $scope.deleteunit = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_New_Units/' + unit_Id)
    .success(function (res) {
        //console.log(res);
        ...
        var request = $http({
            method: "put",
            url: "http://minvent.azurewebsites.net/api/NewUnits/" + ID,
            crossdomain: true,
            data: {
