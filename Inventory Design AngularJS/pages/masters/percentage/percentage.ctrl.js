...
scotchApp.controller('percentageController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.save = function () {
        ...
        if (percentage == null) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/Percentages",
                crossDomain: true,
                data: {
    ...
    $scope.editUnits = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/Percentages/' + percentage_Id)
     .success(function (res) {
         console.log(res);
    ...
    $scope.update = function () {
        ...
        var request = $http({
            method: "put",
            url: "http://minvent.azurewebsites.net/api/Percentages/" + percentage_Id,
            crossDomain: true,
            data: {
                ID: percentage_Id,
