...
scotchApp.controller('userController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //code for GET Role
    $http.get('http://minvent.azurewebsites.net/api/View_Role')
       .success(function (res) {
           //console.log(res);
           $scope.getRole = res;
    ...
    //code for GET City
    $http.get('http://minvent.azurewebsites.net/api/View_Companies')
       .success(function (res) {
           console.log(res);
    ...
    $scope.cancelAndNew = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_Users_Role')
     .success(function (res) {
         $scope.getUser = res;
