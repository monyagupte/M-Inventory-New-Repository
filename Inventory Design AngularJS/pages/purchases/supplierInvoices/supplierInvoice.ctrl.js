...
scotchApp.controller('supplierInvoicesController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //code for GET CITY
    $http.get('http://minvent.azurewebsites.net/api/Country_State_City_View')
    ...
    $http.get('http://minvent.azurewebsites.net/api/Percentages')
       .success(function (res) {
           //console.log(res);
    ...
    $http.get('http://minvent.azurewebsites.net/api/View_Unit')
       .success(function (res) {
           //  console.log(res);
           $scope.getUnits = res;
       })
    ...
    $http.get('http://minvent.azurewebsites.net/api/View_Categories')
       .success(function (res) {
           // console.log(res);
    ...
    $scope.savecustomer = function () {
        ...
        if (Name == null || City_Id == null || City_Id == "" || ContactNo == null || ContactNo2 == null || EmailId == null || EmailId2 == null || VatNo == null || TinNo == null || Street == null || Area == null || Pincode == null || Note == null) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/customers",
                crossDomain: true,
                data: {
    ...
    $scope.saveItem = function () {
        ...
        var request = $http({
            method: "post",
            url: "http://minvent.azurewebsites.net/api/items",
            crossDomain: true,
            data: {
                Code: Code,
                ItemName: ItemName,
 ...
 .success(function (res) {
    ...
    var removeItem = [];
    //Get customer 
    $http.get('http://minvent.azurewebsites.net/api/Supplier_View')
      .success(function (res) {
          //  console.log(res);
          $scope.getCustomers = res;
    ...
    $scope.custid = function (CustomerName) {
        var id = CustomerName;
        $http.get('http://minvent.azurewebsites.net/api/Supplier_View/' + id)
     .success(function (res) {
         // console.log(res);
         ...
         $scope.payment = function (netamount) {
             ...
             var request = $http({
                 method: "post",
                 url: "http://minvent.azurewebsites.net/api/PurchaseInvoices",
                 crossDomain: true,
                 data: {
                     //DataFiledName:VariableName
         ...
         $scope.savePayment = function () {
             ...
             if (this.ddlPaymentType == 'Cheque') {
                 ...
                 var request = $http({
                     method: "post",
                     url: "http://minvent.azurewebsites.net/api/SupplierPayments",
                     crossDomain: true,
                     data: {
                         Supplier_ID: Supplier_Id,
    ...
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/Taxes')
       .success(function (res) {
           // console.log(res);
           $scope.getTaxs = res;
       })
    ...
    $scope.toggleModal = function (selecteditem) {
        if (this.CustomerName == null || this.CustomerName == "") {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_Item/' + getitem_id)
           .success(function (res) {
               ...
               $scope.additeminlist = function () {
                   ...
                   if (qty == null || qty == "") {
                       ...
                       var request = $http({
                           ...
                           method: "post",
                           url: "http://minvent.azurewebsites.net/api/Supplier_Item_Invoice",
                           crossDomain: true,
                           data: {
                           ...
                           $http.get('http://minvent.azurewebsites.net/api/View_Supplier_Item_Invoice?supplier_Id=' + supplier_id + '&insertedDate=' + insertedDate)
                              .success(function (res) {
                                  $scope.additem = res;
                              })
                       });
                       ...
                       var request = $http({
                           ...
                           method: "put",
                           url: "http://minvent.azurewebsites.net/api/Items/" + getitem_id,
                           crossDomain: true,
                           data: {
                               //DataFiledName:VariableName
                               Id: getitem_id,
               ...
               $scope.deleteitemfrmlist = function (index, aitem) {
                   ...
                   $http.get('http://minvent.azurewebsites.net/api/view_Item_for_delivery_Challan/' + aitem.Item_Id)
                  .success(function (res) {
                   ...
                   var request = $http({
                       ...
                       method: "put",
                       url: "http://minvent.azurewebsites.net/api/Items/" + aitem.Item_Id,
                       crossDomain: true,
                       data: {
                           //DataFiledName:VariableName
                           Id: $scope.getItemId1,
                   ...
                   var request = $http({
                       ...
                       method: "delete",
                       url: "http://minvent.azurewebsites.net/api/Supplier_Item_Invoice/" + itemid,
                       crossDomain: true,
                       data: {
    ...
    $scope.removeItemFromItemList = function (id, quantity, itemId) {
         ...
         $http.get('http://minvent.azurewebsites.net/api/view_Item_for_delivery_Challan/' + itemId)
        .success(function (res) {
            // console.log(res);
            $scope.getItemstocks1 = res;
            ...
            var request = $http({
                ...
                method: "put",
                url: "http://minvent.azurewebsites.net/api/Items/" + itemId,
                crossDomain: true,
                data: {
                    //DataFiledName:VariableName
                    Id: itemId,
        ...
        var request = $http({
            ...
            method: "delete",
            url: "http://minvent.azurewebsites.net/api/Supplier_Item_Invoice/" + id,
            crossDomain: true,
            data: {
