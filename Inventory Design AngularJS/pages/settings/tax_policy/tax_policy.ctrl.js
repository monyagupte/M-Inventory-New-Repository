...
scotchApp.controller('TaxPolicyController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/View_TaxPolicy')
    ...
    $scope.editTaxpolicy = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_TaxPolicy/' + taxpolicy_Id)
         .success(function (res) {
        console.log(res);
    ...
    $http.get('http://minvent.azurewebsites.net/api/View_Taxe')
      .success(function (res) {
          $scope.getTaxs = res;
      })
    ...
    $scope.save = function () {
        ...
        if (group_name == null || purpose == null || tid  == "null" ) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/TaxPolicies",
                crossDomain: true,
                data: {
    ...
    $scope.updateSave = function () {
        ...
        if (g_name == null || purpose == null || tid == "null" ) {
            ...
            var request = $http({
                method: "put",
                url: "http://minvent.azurewebsites.net/api/TaxPolicies/" + ID,
                crossdomain: true,
                data: {
                    ID: ID,
                    group_name: g_name,
    ...
    $scope.deleteCategories = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_TaxPolicy/' + tid)
     .success(function (res) {
         console.log(res);
         ...
         var request = $http({
             //method: "delete",
             method: "delete",
             url: "http://minvent.azurewebsites.net/api/TaxPolicies/" +tid,
             crossDomain: true,
             data: {
                 //db=var
