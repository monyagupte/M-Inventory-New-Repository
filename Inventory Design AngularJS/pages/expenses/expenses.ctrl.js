...
scotchApp.controller('expensesController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.save = function ()
    {
        ...
        if (Description == null || AmounT == null || DatE == null)
        {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/Expens",
                crossDomain: true,
                data: {
    ...
    $scope.deletetax = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/Expens/' + Exp_Id)
    .success(function (res) {
       // console.log(res);
        ...
        var request = $http({
            method: "put",
            url: "http://minvent.azurewebsites.net/api/Expens/" + ID,
            crossdomain: true,
            data: {
    ...
    $scope.update = function () {
       ...
       // alert(user_Id)
        $http.get('http://minvent.azurewebsites.net/api/Expens/' + expenses_Id)
    .success(function (res) {
         console.log(res);
