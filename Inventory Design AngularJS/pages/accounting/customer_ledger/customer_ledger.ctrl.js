...
scotchApp.controller('customerLedgerController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.custid = function (CustomerName) {
        ...
        //$http.get('http://minvent.azurewebsites.net/api/view_customerpayment/' + cust_id +"?paymentType=Cash")
        $http.get('http://minvent.azurewebsites.net/api/view_customerpayment/' + cust_id )
       .success(function (res) {
           // console.log(res);
