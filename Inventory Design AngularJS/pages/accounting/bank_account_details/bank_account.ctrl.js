...
scotchApp.controller('bankAccountDetailsController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/View_Banks')
    ...
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/View_Bank_Accounts')
       .success(function (res) {
           // console.log(res);
    ...
    $scope.saveBankAccount = function () {
        ...
        if (AccountNumber == null || AccountName == null || Bank == null) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/BankAccounts",
                crossDomain: true,
                data: {
    ...
    $scope.editBankAcc = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/BankAccounts/' + BankAcc_Id)
     .success(function (res) {
    ...
    $scope.updateBankAccount = function () {
        ...
        var request = $http({
            method: "put",
            url: "http://minvent.azurewebsites.net/api/BankAccounts/" + bankAcc_Id,
            crossDomain: true,
            data: {
                Id: bankAcc_Id,
                AccountNumber: AccountNumber,
    ...
    $scope.deleteBankAcc = function () {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_Bank_Accounts/' + bankAcc_Id)
     .success(function (res) {
         console.log(res);
