var scotchApp = angular.module('scotchApp.customerCheque', ['ngRoute']);
    ...
    var ptype = "Cheque"
    //code for GET
        $http.get('http://minvent.azurewebsites.net/api/view_CustomerCheque?PaymentType=' + ptype)
    ...
    $scope.changePaymentDate = function (Duration) {
        ...
        if (duration == "LastMonths") {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_CustomerCheque?PaymentDate=' + date)
            .success(function (res) {
                // console.log(res);
                $scope.getCustomer = res;
            })
   ...
   },
   {
    ...
    $scope.Allchecked = function (chk) {
        ...
        if (chk == true) {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_CustomerPayment?PaymentType=' + ptype)
                .success(function (res) {
                    // console.log(res);
                ...
                for (var i = 0; i < Sids; i++) {
                    ...
                    //if (Arrayspcopy[i].Status == true) {
                        ...
                        var request = $http({
                            ...
                            method: "put",
                            url: "http://minvent.azurewebsites.net/api/CustomerPayments/" + SpId,
                            crossDomain: true,
                            data: {
    ...
    $scope.CheckData = function (chk, data) {
        ...
        if (chk == true) {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_CustomerPayment?ChequeNumber=' + $scope.chequeNo)
                .success(function (res) {
                    // console.log(res);
    ...
    $scope.deleteCheque = function (data) {
        ...
        $http.get('http://minvent.azurewebsites.net/api/view_CustomerPayment?ChequeNumber=' + chequeno)
           .success(function (res) {
               // console.log(res);
               ...
               var request = $http({
                   ...
                   method: "put",
                   url: "http://minvent.azurewebsites.net/api/customerPayments/" + ID,
                   crossDomain: true,
                   data: {
                       Id: ID,
