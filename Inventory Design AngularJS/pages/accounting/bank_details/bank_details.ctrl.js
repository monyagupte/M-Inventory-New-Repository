...
scotchApp.controller('bankDetailsController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.saveBank = function () {
        ...
        if (BankName == null || Branch == null || IFSCcode == null) {
            ...
            var request = $http({
                method: "post",
                url: "http://minvent.azurewebsites.net/api/Banks",
                crossDomain: true,
                data: {
                    BankName: BankName,
                    IFSCCode: IFSCcode,
    ...
    //edit bank
       $scope.editBank = function () {
           ...
           $http.get('http://minvent.azurewebsites.net/api/Banks/' + Bank_Id)
        .success(function (res) {
    ...
    //update bank
       $scope.updateBank = function () {
           ...
           if (BankName == null || Branch == null || IFSCcode == null) {
               ...
               var request = $http({
                   method: "put",
                   url: "http://minvent.azurewebsites.net/api/Banks/" + bank_Id,
                   crossDomain: true,
                   data: {
                       Id: bank_Id,
                       BankName: BankName,
    ...
    //delete bank
       $scope.deleteBank = function () {
           ...
           $http.get('http://minvent.azurewebsites.net/api/View_Banks/' + bank_Id)
        .success(function (res) {
            console.log(res);
            $scope.getbanks = res;
