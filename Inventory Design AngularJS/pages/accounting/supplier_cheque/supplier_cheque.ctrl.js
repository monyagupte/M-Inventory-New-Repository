...
scotchApp.controller('supplierChequeController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
  ...
  var ptype="Cheque"
    //code for GET
    $http.get('http://minvent.azurewebsites.net/api/View_SupplierCheque?PaymentType=' + ptype)
    ...
    $scope.Allchecked=function(chk)
    {
       ...
       if(chk==true){
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_SupplierPayment?PaymentType=' + ptype)
            .success(function (res) {
                // console.log(res);
            ...
            for (var i = 0; i < Sids; i++) {
                ...
                if (Arrayspcopy[i].Status==true){
                    ...
                    var request = $http({
                        ...
                        method: "put",
                            url: "http://minvent.azurewebsites.net/api/SupplierPayments/" + SpId,
                        crossDomain: true,
                        data: {
    ...
    $scope.CheckData = function (chk,data) {
      ...
      //  alert(d.ChequeNumber);
       ...
       Sid = Sid + 1;
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_SupplierPayment?ChequeNumber=' + $scope.chequeNo)
            .success(function (res) {
                // console.log(res);
    ...
    $scope.deleteCheque = function (data) {
        ...
        $http.get('http://minvent.azurewebsites.net/api/View_SupplierPayment?ChequeNumber=' +chequeno)
           .success(function (res) {
               // console.log(res);
               ...
               var request = $http({
                   ...
                   method: "put",
                   url: "http://minvent.azurewebsites.net/api/SupplierPayments/" + ID,
                   crossDomain: true,
                   data: {
                       Id: ID,
