...
scotchApp.controller('generalLedgerController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    //Get customer name
    //$http.get('http://minvent.azurewebsites.net/api/view_customerpayment/')
    ...
    $scope.ShowCustomerRecordsForCashAndBankbalance = function () {
        ...
        if (customer == true || allStatementRecord == true) {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_customerpayment?paymenttype=cash')
     .success(function (res) {
         //console.log(res);
         $scope.getLedger = res;
         var ledger = $scope.getLedger;
         ...
         for (var i = 0; i <= count; i++) {
            ...
            $http.get('http://minvent.azurewebsites.net/api/view_customerpayment?paymenttype=Cheque')
     .success(function (res) {
         //console.log(res);
         $scope.getLedger = res;
         var ledger = $scope.getLedger;
    ...
    $scope.ShowContraEntryRecords = function () {
        ...
        if (contraEntry == true || allStatementRecord == true) {
            ...
            //Get Customer from payment Type =cash 
            $http.get('http://minvent.azurewebsites.net/api/contraentries')
     .success(function (res) {
         //console.log(res);
         $scope.getLedger = res;
         var ledger = $scope.getLedger;
        ...
        $scope.ShowSupplierRecordsforCashAndBankBalance = function () {
            ...
            if (supplier == true || allStatementRecord == true) {
                ...
                $http.get('http://minvent.azurewebsites.net/api/View_Supplier_Ledger?payemntType=Cash')
         .success(function (res) {
             //console.log(res);
             $scope.getLedger = res;
             var ledger = $scope.getLedger;
             ...
             // alert('supplier cash');
                ...
                //Get Customer from payment Type =Cheque 
                $http.get('http://minvent.azurewebsites.net/api/View_Supplier_Ledger?payemntType=Cheque')
         .success(function (res) {
             //console.log(res);
             $scope.getLedger = res;
             var ledger = $scope.getLedger;
        ...
        $scope.ShowExpensesRecords = function () {
            ...
            if (allExpenses == true || allStatementRecord == true) {
                $http.get('http://minvent.azurewebsites.net/api/Expens')
         .success(function (res) {
             // console.log(res);
             $scope.getExpens = res;
