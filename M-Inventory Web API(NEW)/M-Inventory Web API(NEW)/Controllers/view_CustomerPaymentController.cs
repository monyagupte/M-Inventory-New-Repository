...
namespace M_Inventory_Web_API_NEW_.Controllers
{
    public class view_CustomerPaymentController : ApiController
    {
        ...
        public IHttpActionResult Postview_CustomerPayment(view_CustomerPayment view_CustomerPayment)
        {
            ...
            {
                if (view_CustomerPaymentExists(view_CustomerPayment.Id))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = view_CustomerPayment.Id }, view_CustomerPayment);
        }
        ...
        {
            return db.view_CustomerPayment.Count(e => e.Id == id) > 0;
        }
    }
}